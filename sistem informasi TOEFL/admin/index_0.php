        ...
        <div class="row h-100">
                ...
                <div class="col-md-12">
                    <ul class="list-group list-group-flush ">
                        <li class="list-group-item bg-aside">
                            <a href="index_0.php" class="text-light text-decoration-none active"><i class="fa fa-home" aria-hidden="true"></i> HOME</a>
                        </li>
                        <li class="list-group-item bg-aside">
            ...
            <div class="col-md-10 mx-0 px-0 d-flex flex-column">
                ...
                <div class="d-flex flex-column pt-2 pl-3">
                    ...
                    <br>
                    <div class="align-self-center text-center p-4 bg-light mt-lg-5">
                        <h2>Selamat Datang</h2>
                        <h5>Anda saat ini berada di dashboard admin FTO (Free Toefl Online)</h5>
                    </div>
                </div>
                <div class="text-center bg-aside text-white p-2 mt-auto">
