...
<html lang="en">
  ...
  <h1 class="display-8">Hai, <?php echo ($nama[0]); ?><br />You Can Start Your TOEFL Simulation Test Score Is</h1>
  <table align="left" border="1">
    ...
    <a href="process/lap_score.php" class="btn btn-primary start-0" style="margin-left: 2rem;">Print it</a>
