    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #e3f2fd">
      <div class="container text-center">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <form class="form-inline ml-auto" method="post" action="process/next_back.php" enctype="multipart/form-data">
        ...
        <div class="col-lg-10 soal">
          <div class="row">
            ...
            <div class="col-lg">
              <p>
                  <?php
                    echo '<img src="data:image/jpeg;base64,'.base64_encode( $data["gambar"] ).'" class="img-fluid">';
                  ?>
              </p>
            </div>
          </div>
